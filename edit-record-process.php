...
<body>
    <div class="container">
        ...
        <form action="record-form.php" method="post">
            ...
            <input type="number" step="0.1" id="glucose_level" name="glucose_level" value="<?php echo $selectedRecord['glucose_level']; ?>" required>

            <label for="entry_date">Entry Date:</label>
            <input type="date" id="entry_date" name="entry_date" value="<?php echo $selectedRecord['entry_date']; ?>" required>
