...
<a href="logout.php">Logout</a>
    <a href="javascript:void(0)" class="icon" onclick="toggleNavbar()"> 
      ...
      <div class="container mt-5">
        <button id="toggleButton" class="btn btn-primary" onclick="toggleContent('content', 'content2')">Emergency contact</button>
        ...
        <button id="toggleButton2" class="btn btn-primary" onclick="toggleContent('content2', 'content')">Video how to self-rescue</button>
        <div id="content2" class="hidden mt-3">
          <h1>2 Ways to Get Up From a Fall</h1>
          <button onclick="openLinkInNewWindow('https://www.youtube.com/watch?v=sotxItsi71A')" class="btn btn-secondary">Reference: Link here</button>
...
<a id="scrollButton" class="btn btn-primary" href="#" role="button">
  ...
  <button id="toggleButton3" class="btn btn-primary" onclick="toggleContent('content3', 'content')">Commonly medicnes</button>
